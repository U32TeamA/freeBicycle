...
<html>
	...
	<div class="container">
		<div id="topbtn" class="btn-group" role="group" style="width:98%;margin:10px 10px 0 10px;">   		  	
   		  	...
   		  	<button type="button" class="btn btn-default" style="margin-top:0.8%;margin-left:0.1%;">
   		  		<span class="glyphicon glyphicon-folder-open"></span>批量退还
   		  	</button>
   		  	<a href="#" type="button" class="btn btn-default" style="margin-top:0.8%;margin-left:0.1%;">
		...
		<table class="table table-striped table-bordered table-condensed" style="width:98%;margin:10px 10px 0 10px;">
			<tr>
				<th><input type="checkbox" name="" value="全选"/>全选</th>
				<th>押金编号</th>
				<th>用户帐号</th>
				<th>押金金额</th>
				<th>押金时间</th>			
			...
			<?php if(is_array($page["rows"])): foreach($page["rows"] as $key=>$rows): ?><tr onclick="checkedThis(this)">
					<td><input type="checkbox" name="ids" value="<?php echo ($rows["pl_id"]); ?>"/></td>
